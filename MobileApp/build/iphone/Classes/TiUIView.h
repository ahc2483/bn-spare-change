...
/**
 Base class for all SpareChangeMobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SpareChangeMobile view hierarchy (such as wrapped iOS UIViews) was touched.
