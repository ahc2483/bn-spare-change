...
//Rare exceptions to indicate a bug in the _sparechangemobile code (Eg, function that a subclass should have implemented)
...
/**
 The base class for SpareChangeMobile proxies.
 */
