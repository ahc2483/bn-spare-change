...
// in simulator we redefine to format for SpareChangeMobile Developer console
...
{\
	NSString * exceptionName = [@"org.sparechangemobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sparechangemobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISpareChangeMobileNativeItemNone = -1, 
	UISpareChangeMobileNativeItemSpinner = -2,
	UISpareChangeMobileNativeItemProgressBar = -3,
	
	UISpareChangeMobileNativeItemSlider = -4,
	UISpareChangeMobileNativeItemSwitch = -5,
	UISpareChangeMobileNativeItemMultiButton = -6,
	UISpareChangeMobileNativeItemSegmented = -7,
	
	UISpareChangeMobileNativeItemTextView = -8,
	UISpareChangeMobileNativeItemTextField = -9,
	UISpareChangeMobileNativeItemSearchBar = -10,
	
	UISpareChangeMobileNativeItemPicker = -11,
	UISpareChangeMobileNativeItemDatePicker = -12,
	
	UISpareChangeMobileNativeItemInfoLight = -13,
	UISpareChangeMobileNativeItemInfoDark = -14,
	
	UISpareChangeMobileNativeItemDisclosure = -15,
	
	UISpareChangeMobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SpareChangeMobile instances of
