...
/**
 The base class for all SpareChangeMobile modules
 */
...
/**
 SpareChangeMobile Platform calls this method on startup.
 */
-(void)startup;

/**
 SpareChangeMobile Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 SpareChangeMobile Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 SpareChangeMobile Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 SpareChangeMobile Platform calls this method on resume.
 @param sender The sender of the event.
 */
