...
@interface SpareChangeMobileObject : KrollCoverageObject {
#else
@interface SpareChangeMobileObject : KrollObject {
#endif
@private
...
extern NSString * SpareChangeMobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SpareChangeMobileObject *_sparechangemobile;
    KrollObject* console;
	BOOL shutdown;
