 ...
 * Copyright (c) 2009-2011 by SpareChangeMobile, Inc. All Rights Reserved.
...
//@interface SpareChangeMobileObject : NSObject
//@end

@interface SpareChangeMobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SpareChangeMobileObject class]])
		{
			for (NSString *key in [[(SpareChangeMobileObject*)o modules] allKeys])
			{
